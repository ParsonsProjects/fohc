...
define('MANAGER_URI', get_template_directory_uri() . '/admin/backend/slider_manager');
...
?>
	...
	<div class="wrap" id="manager_wrap">
        ...
        <div class="alert alert-info">Looking to change the banners settings then go <a href="themes.php?page=options-framework#of-option-bannersettings" title="Banner Settings">here</a>.</div>
