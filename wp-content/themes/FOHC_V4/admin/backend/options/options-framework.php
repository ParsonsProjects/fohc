...
function optionsframework_load_styles() {
	wp_enqueue_style('optionsframework', OPTIONS_FRAMEWORK_DIRECTORY.'assets/css/optionsframework.css');
	wp_enqueue_style('color-picker', OPTIONS_FRAMEWORK_DIRECTORY.'assets/css/colorpicker.css');
	wp_enqueue_style('font-awesome', OPTIONS_FRAMEWORK_DIRECTORY.'assets/css/font-awesome.min.css');
	wp_enqueue_style('font-awesome-ie7', OPTIONS_FRAMEWORK_DIRECTORY.'assets/css/font-awesome-ie7.min.css');
}	
...
function optionsframework_load_scripts($hook) {
	...
	wp_enqueue_script('color-picker', OPTIONS_FRAMEWORK_DIRECTORY.'assets/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY.'assets/js/options-custom.js', array('jquery'));
...
?>
	...
	<div id="optionsframework-wrap" class="wrap">
        ...
        <div id="optionsframework-metabox" class="metabox-holder">
            <div id="optionsframework" class="box">
