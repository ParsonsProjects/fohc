...
define('MANAGER_URI', get_template_directory_uri() . '/admin/slider_manager');
...
if(get_option('slides_v4')) {
	$slides = get_option('slides_v4');
} else {
	$slides = false;	
}
...
function manager_admin_menu() {
	...
	if(isset($_GET['page']) && $_GET['page'] == 'slidermanager') {
		...
		if(isset($_POST['action']) && $_POST['action'] == 'save') {
			...
			update_option('slides_v4', $slides);
	...
	<div class="wrap" id="manager_wrap">
		...
		<form action="" id="manager_form" method="post">
			...
			<ul id="manager_form_wrap" class="metabox-holder">
             ...
             <?php if(get_option('slides_v4')) : $slides = get_option('slides_v4'); ?>
